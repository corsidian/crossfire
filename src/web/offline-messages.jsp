...
<jsp:useBean id="webManager" class="org.b5chat.crossfire.core.util.WebManager" scope="page" />
	...
	<div class="b5chat-contentBox">
		...
		<tbody>
			<tr valign="top" class="">
				...
				<td width="99%">
					<label for="rb03"><b><fmt:message key="offline.messages.store_option" /></b></label> - <fmt:message key="offline.messages.storage_crossfire" />
				</td>
			</tr>
			<tr valign="top">
				<td width="1%" nowrap>
