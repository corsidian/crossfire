...
<%@ page import="net.emiva.crossfire.ConnectionManager,
                 net.emiva.crossfire.SessionManager,
                 net.emiva.crossfire.XMPPServer,
                 net.emiva.crossfire.multiplex.ConnectionMultiplexerManager,
                 net.emiva.crossfire.session.ConnectionMultiplexerSession,
