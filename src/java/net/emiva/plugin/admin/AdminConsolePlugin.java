...
import net.emiva.crossfire.core.container.CertificateEventListener;
...
public class AdminConsolePlugin implements IPlugin {
    ...
    private ICertificateEventListener certificateListener;
    ...
    public AdminConsolePlugin() {
        ...
        System.setProperty("org.apache.commons.logging.LogFactory", "net.emiva.util.log.util.CommonsLogFactory");
    }
    ...
    public void startup() {
        ...
        certificateListener = new CertificateEventListener(this);
