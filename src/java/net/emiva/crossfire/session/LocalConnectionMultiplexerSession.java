...
import net.emiva.crossfire.multiplex.MultiplexerPacketDeliverer;
 ...
 * sessions are present in {@link SessionManager} but not in {@link net.emiva.crossfire.RoutingTable}. Use
 * {@link SessionManager#getConnectionMultiplexerSessions(String)} to get all sessions or
 * {@link net.emiva.crossfire.multiplex.ConnectionMultiplexerManager#getMultiplexerSession(String)}
...
public class LocalConnectionMultiplexerSession extends LocalSession implements ConnectionMultiplexerSession {
    ...
    static {
        ...
        String policyName = EMIVAGlobals.getProperty("xmpp.multiplex.tls.policy",
        ...
        policyName = EMIVAGlobals.getProperty("xmpp.multiplex.compression.policy",
    ...
    public static void setTLSPolicy(SocketConnection.TLSPolicy policy) {
        tlsPolicy = policy;
        EMIVAGlobals.setProperty("xmpp.multiplex.tls.policy", tlsPolicy.toString());
    }
    ...
    public static void setCompressionPolicy(SocketConnection.CompressionPolicy policy) {
        ...
        EMIVAGlobals.setProperty("xmpp.multiplex.compression.policy", compressionPolicy.toString());
    }
