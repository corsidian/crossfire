 ...
 * {@link net.emiva.crossfire.XMPPServer#setRemoteSessionLocator(RemoteSessionLocator)} to
 * set the session locator to use. When not running inside of a cluster
 * {@link net.emiva.crossfire.XMPPServer#getRemoteSessionLocator()} will always return null.
 *
