...
import net.emiva.crossfire.audit.AuditStreamIDFactory;
...
import net.emiva.crossfire.offline.OfflineMessage;
 ...
 * @author Derek DeMoro
 */
public class SessionManager extends BasicModule implements IClusterEventListener {
    ...
    public void joinedCluster() {
        ...
        for (IClientSession session : routingTable.getClientsRoutes(true)) {
