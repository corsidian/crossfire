 ...
 * the implementation with crossfire in the <tt>crossfire.xml</tt>
...
public interface IAuthProvider {
    ...
    /**
     * Returns true if this IAuthProvider supports authentication using plain-text
    ...
    /**
     * Returns true if this IAuthProvider supports digest authentication
     ...
     * @throws InternalUnauthenticatedException if there is a problem authentication crossfire iteself into the user and group system
     */
    ...
    /**
     * Returns true if this IUserProvider is able to retrieve user passwords from
     ...
     *
     * @return true if this IUserProvider is able to retrieve user passwords from the
     *         backend user store.
     */
