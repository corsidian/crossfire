 ...
 *
 * <ul>
 * <li><tt>provider.auth.className = net.emiva.crossfire.auth.POP3AuthProvider</tt></li>
 * <li><tt>provider.user.className = net.emiva.crossfire.user.POP3UserProvider</tt></li>
 * </ul>
 *
