...
import net.emiva.crossfire.user.NativeUserProvider;
 ...
 *
 * <ul>
 * <li><tt>provider.auth.className = net.emiva.crossfire.auth.NativeAuthProvider</tt></li>
 * <li><tt>provider.user.className = net.emiva.crossfire.user.NativeUserProvider</tt></li>
 * </ul>
 *
