 ...
 * <tt>net.emiva.crossfire.auth.HybridAuthProvider</tt>.
 *
 * The primary, secondary, and tertiary providers are configured be setting system properties similar to
 * the following:
 *
 * <ul>
 * <li><tt>hybridAuthProvider.primaryProvider = net.emiva.crossfire.auth.DefaultAuthProvider</tt></li>
 * <li><tt>hybrodAuthProvider.secondaryProvider = net.emiva.crossfire.auth.NativeAuthProvider</tt></li>
 * </ul>
 *
