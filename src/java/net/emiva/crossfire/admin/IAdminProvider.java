 ...
 */
package net.emiva.crossfire.admin;
...
/**
 * An IAdminProvider handles storage of information about admin accounts, and requests to
...
public interface IAdminProvider {
     ...
     * change who is an admin from the crossfire admin interface.
     *
