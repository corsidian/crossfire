 ...
 * $Date  $
 *
 * Copyright (C) 1999-2008 EMIVA Community. All rights reserved.
 *
...
package net.emiva.crossfire.stats;
...
public interface IStatistic {
    ...
    public enum Type {
         ...
         * file transfers. Each time the {@link IStatistic#sample()} method is invoked, it should
         ...
         * {@link IStatistic#sample()} method is invoked, it should return the "amount" of data
         ...
         * number of users in multi-user chats. Each time the {@link IStatistic#sample()}
         ...
         * connected to the server. Each time the {@link IStatistic#sample()}
         * method is invoked, it should return the current measurement of the data, irrelevant of
