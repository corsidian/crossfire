...
package net.emiva.crossfire.group;
...
public class GroupEventDispatcher {
    ...
    private static List<IGroupEventListener> listeners =
            new CopyOnWriteArrayList<IGroupEventListener>();
     ...
     */
    public static void addListener(IGroupEventListener listener) {
        if (listener == null) {
     ...
     * @param listener the listener.
     */
    public static void removeListener(IGroupEventListener listener) {
