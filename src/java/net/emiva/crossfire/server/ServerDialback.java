...
import net.emiva.crossfire.RemoteConnectionFailedException;
...
import net.emiva.crossfire.net.DNSUtil;
...
public class ServerDialback {
     ...
     * {@link #validateRemoteDomain(org.dom4j.Element, net.emiva.crossfire.StreamID)} for
