 ...
 */
public class XMPPServerInfoImpl implements IXmppServerInfo {
     ...
     */
    public XMPPServerInfoImpl(String xmppDomain, String hostname, Version version, Date startDate, IConnectionManager connectionManager) {
