...
public abstract class SocketReader implements Runnable {
     ...
     * {@link net.emiva.crossfire.interceptor.PacketInterceptor} will be invoked before
    ...
    /**
     * Creates the appropriate {@link net.emiva.crossfire.session.Session} subclass based on the specified namespace.
     *
