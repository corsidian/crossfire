...
package net.emiva.crossfire.presence;
 ...
 * {@link PresenceEventDispatcher#addListener(IPresenceEventListener)}
 * method to register for events.
 *
 * @author Gaston Dombiak
 */
public interface IPresenceEventListener {
     ...
     */
    public void availableSession(IClientSession session, Presence presence);
     ...
     */
    public void unavailableSession(IClientSession session, Presence presence);
     ...
     */
    public void presenceChanged(IClientSession session, Presence presence);
