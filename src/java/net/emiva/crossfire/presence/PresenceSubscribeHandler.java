 ...
 */
public class PresenceSubscribeHandler extends BasicModule implements IChannelHandler<Presence> {
        ...
        try {            
            ...
            try {
                ...
                if (!(type == Presence.Type.subscribed && recipientRoster != null && !recipientSubChanged)) {
                    ...
                    // ISession the packet will be routed to the client. If a route cannot be found
