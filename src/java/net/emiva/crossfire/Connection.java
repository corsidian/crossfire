...
public interface Connection {
     ...
     *       {@link net.emiva.crossfire.net.ClientTrustManager} will be used for verifying certificates
     *       otherwise a {@link net.emiva.crossfire.net.ServerTrustManager} will be used.
