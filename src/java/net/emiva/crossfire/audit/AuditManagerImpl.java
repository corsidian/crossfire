...
import net.emiva.crossfire.interceptor.IPacketInterceptor;
...
/**
 * Implementation of the IAuditManager interface.
 */
public class AuditManagerImpl extends BasicModule implements IAuditManager {
...
//        }
    ...
    private class AuditorInterceptor implements IPacketInterceptor {

        public void interceptPacket(Packet packet, ISession session, boolean read, boolean processed) {
            if (!processed) {
