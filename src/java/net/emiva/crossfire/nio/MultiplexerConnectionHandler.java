...
import net.emiva.crossfire.net.MultiplexerStanzaHandler;
...
/**
 * ConnectionHandler that knows which subclass of {@link net.emiva.crossfire.net.StanzaHandler} should
 * be created and how to build and configure a {@link net.emiva.crossfire.nio.NIOConnection}.
 *
...
public class MultiplexerConnectionHandler extends ConnectionHandler {
    ...
    @Override
	int getMaxIdleTime() {
        return EMIVAGlobals.getIntProperty("xmpp.multiplex.idle", 5 * 60 * 1000) / 1000;
    }
}
