...
/**
 * <p>
 * A <code>IUserItemsProvider</code> is responsible for providing the items associated with a user
 * that are to be discovered during a disco#items query sent to the user.
 * </p>
 * 
 * <p>
 * Examples of when a <code>IUserItemsProvider</code> is used include:
 * </p>
 * <ul>
