...
public interface IUserProvider {
    ...
    /**
     * Returns true if this IUserProvider is read-only. When read-only,
    ...
    /**
     * Returns true if this IUserProvider requires a name to be set on User objects.
     *
    ...
    /**
     * Returns true if this IUserProvider requires an email address to be set on User objects.
     *
