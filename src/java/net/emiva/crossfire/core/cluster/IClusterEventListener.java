...
/**
 * Listener for cluster events. Use {@link ClusterManager#addListener(IClusterEventListener)}
 * to add new listeners.
 *
 * @author Gaston Dombiak
 */
public interface IClusterEventListener {

    /**
     * Notification event indicating that this JVM is now part of a cluster. At this point the
     * {@link net.emiva.crossfire.server.XmppServer#getNodeID()} holds the new nodeID value.<p>
     *
