 ...
 */
public class SSLGlobalTrustManagerFactory {

	private static final Logger Log = LoggerFactory.getLogger(SSLGlobalTrustManagerFactory.class);
    ...
    public static TrustManager[] getTrustManagers(KeyStore truststore,
		...
		try {
			...
			trustManagers = null;
			Log.error("SSLGlobalKeyManagerFactory startup problem.\n" +
