...
package net.emiva.crossfire.core.net;
...
public class ClientStanzaHandler extends StanzaHandler {
    ...
    public ClientStanzaHandler(IPacketRouter router, String serverName, IConnection connection) {
    ...
    @Override
	boolean createSession(String namespace, String serverName, XmlPullParser xpp, IConnection connection)
            throws XmlPullParserException {
        if ("jabber:client".equals(namespace)) {
            // The connected client is a regular client so create a IClientSession
	...
	void startTLS() throws Exception {
        IConnection.ClientAuth policy;
        try {
            policy = IConnection.ClientAuth.valueOf(Globals.getProperty("xmpp.client.cert.policy", "disabled"));
        } catch (IllegalArgumentException e) {
            policy = IConnection.ClientAuth.disabled;
        }
