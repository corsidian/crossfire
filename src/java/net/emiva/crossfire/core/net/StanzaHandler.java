...
public abstract class StanzaHandler {
     ...
     * {@link net.emiva.crossfire.interceptor.IPacketInterceptor} will be invoked before
     ...
     * @throws net.emiva.crossfire.auth.UnauthorizedException
    ...
    private boolean compressClient(Element doc) {
        String error = null;
        if (connection.getCompressionPolicy() == IConnection.CompressionPolicy.disabled) {
