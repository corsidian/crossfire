...
import net.emiva.crossfire.auth.AuthorizationManager;
import net.emiva.crossfire.core.net.sasl.SASLAuthentication;
import net.emiva.crossfire.core.net.sasl.VerifyPasswordCallback;
 ...
 * operation requires that the IUserProvider being used supports passwords retrival.
    ...
    public void handle(final Callback[] callbacks)
        ...
        for (Callback callback : callbacks) {
            if (callback instanceof RealmCallback) {
                ...
                try {
                    // Get the password from the IUserProvider. Some UserProviders may not support
                    // this operation
