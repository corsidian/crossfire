...
package net.emiva.crossfire.core.net.sasl;
...
import net.emiva.crossfire.core.net.XMPPCallbackHandler;
 ...
 * <ol>
 *      <li>The type of {@link net.emiva.crossfire.user.IUserProvider} being used since
...
public class SASLAuthentication {
    ...
    private static void initMechanisms() {
        ...
        Security.addProvider(new net.emiva.crossfire.core.net.sasl.SASLProvider());
    }
}
