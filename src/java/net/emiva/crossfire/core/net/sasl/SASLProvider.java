...
public class SASLProvider extends Provider {
    ...
    public SASLProvider() {
        ...
        put("SaslServerFactory.PLAIN", "net.emiva.crossfire.core.net.sasl.SASLServerFactoryImpl");
        // Add SaslServer supporting the Clearspace SASL mechanism
        put("SaslServerFactory.CLEARSPACE", "net.emiva.crossfire.core.net.sasl.SASLServerFactoryImpl");
    }
}