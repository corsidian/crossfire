...
package net.emiva.crossfire.core.plugin;

import java.io.File;

/**
 * IPlugin interface. Plugins enhance the functionality of crossfire. They can:<ul>
 *
 ...
 *      <li>Use the crossfire API to add new functionality to the server.
 * </ul>
 *
 ...
 * required, and specifies the className of the IPlugin implementation. The XML file
 ...
 *
 * Please see the IPlugin Developer Guide (available with the
 * crossfire documentation) for additional details about plugin development.
 *
 * @author Matt Tucker
 */
public interface IPlugin {
     ...
     * and references to core crossfire classes. In other words, a
