...
package net.emiva.crossfire.core.nio;
...
import net.emiva.crossfire.IConnectionCloseListener;
import net.emiva.crossfire.auth.UnauthorizedException;
import net.emiva.crossfire.core.net.ssl.ClientTrustManager;
import net.emiva.crossfire.core.net.ssl.SSLConfig;
import net.emiva.crossfire.core.net.ssl.SSLGlobalKeyManagerFactory;
import net.emiva.crossfire.core.net.ssl.SSLGlobalTrustManagerFactory;
...
public class NIOConnection implements IConnection {
    ...
    public void startTLS(boolean clientMode, String remoteServer, ClientAuth authentication) throws Exception {
        ...
        KeyManager[] km = SSLGlobalKeyManagerFactory.getKeyManagers(ksKeys, keypass);

        // TrustManager's decide whether to allow connections.
        TrustManager[] tm = SSLGlobalTrustManagerFactory.getTrustManagers(ksTrust, trustpass);
