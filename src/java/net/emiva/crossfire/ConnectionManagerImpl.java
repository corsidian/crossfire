...
import net.emiva.crossfire.core.net.SocketSendingTracker;
import net.emiva.crossfire.core.net.StalledSessionsFilter;
import net.emiva.crossfire.core.net.ssl.SSLConfig;
import net.emiva.crossfire.core.nio.ClientConnectionHandler;
import net.emiva.crossfire.core.nio.XMPPCodecFactory;
import net.emiva.crossfire.core.plugin.PluginManager;
import net.emiva.crossfire.core.plugin.IPluginManagerListener;
...
import net.emiva.util.ICertificateEventListener;
...
public class ConnectionManagerImpl extends BasicModule implements IConnectionManager, ICertificateEventListener {
