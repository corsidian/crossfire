...
package net.emiva.crossfire.offline;
...
import net.emiva.crossfire.disco.IDiscoInfoProvider;
import net.emiva.crossfire.disco.DiscoItem;
import net.emiva.crossfire.disco.IDiscoItemsProvider;
 ...
 */
public class IQOfflineMessagesHandler extends IqHandler implements IServerFeaturesProvider,
        IDiscoInfoProvider, IDiscoItemsProvider {
