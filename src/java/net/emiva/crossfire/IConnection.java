...
public interface IConnection {
     ...
     * @throws net.emiva.crossfire.auth.UnauthorizedException if a permission error was detected.
     */
     ...
     *       {@link net.emiva.crossfire.core.net.ssl.ClientTrustManager} will be used for verifying certificates
     *       otherwise a {@link net.emiva.crossfire.core.net.ServerTrustManager} will be used.
