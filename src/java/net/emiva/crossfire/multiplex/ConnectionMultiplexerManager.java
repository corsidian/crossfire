...
package net.emiva.crossfire.multiplex;
...
import net.emiva.crossfire.event.SessionEventListener;
import net.emiva.crossfire.session.ConnectionMultiplexerSession;
...
public class ConnectionMultiplexerManager implements SessionEventListener {
    ...
    public static String getDefaultSecret() {
        return EMIVAGlobals.getProperty("xmpp.multiplex.defaultSecret");
    }
    ...
    public static void setDefaultSecret(String defaultSecret) {
        EMIVAGlobals.setProperty("xmpp.multiplex.defaultSecret", defaultSecret);
    }
    ...
    private ConnectionMultiplexerManager() {
        ...
        TaskEngine.getInstance().schedule(heartbeatTask, 30*EMIVAConstants.SECOND, 30*EMIVAConstants.SECOND);
    }
