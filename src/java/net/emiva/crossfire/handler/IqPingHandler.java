...
package net.emiva.crossfire.handler;
 ...
 */
public class IqPingHandler extends IqHandler implements IServerFeaturesProvider {
	...
	/*
	 * @see
	 * net.emiva.crossfire.handler.IqHandler#handleIQ(org.xmpp.packet.IQ)
	 */
	@Override
	...
	/*
	 * @see net.emiva.crossfire.handler.IqHandler#getInfo()
	 */
	@Override
	...
	/*
	 * @see net.emiva.crossfire.disco.IServerFeaturesProvider#getFeatures()
	 */
