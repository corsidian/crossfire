 ...
 */
public abstract class IqHandler extends BasicModule implements IChannelHandler {

	private static final Logger Log = LoggerFactory.getLogger(IqHandler.class);

    protected IPacketDeliverer deliverer;
    ...
    public void process(Packet packet) throws PacketException {
        ...
        catch (net.emiva.crossfire.auth.UnauthorizedException e) {
            if (iq != null) {
                try {
