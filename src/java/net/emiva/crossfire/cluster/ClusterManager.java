...
package net.emiva.crossfire.cluster;
...
public class ClusterManager {
     ...
     * {@link net.emiva.crossfire.XMPPServer#getNodeID()} holds the new nodeID value and
     ...
     * {@link XMPPServer#setRemoteSessionLocator(net.emiva.crossfire.session.RemoteSessionLocator)} and
     * {@link net.emiva.crossfire.RoutingTable#setRemotePacketRouter(net.emiva.crossfire.RemotePacketRouter)}
