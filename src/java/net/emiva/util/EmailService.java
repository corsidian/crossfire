 ...
 *
 * Copyright (C) 2003-2008 EMIVA Community. All rights reserved.
 *
 ...
 * </pre><p>
 *
 * This class is configured with a set of emiva properties:<ul>
...
public class EmailService {
    ...
    private static final String SSL_FACTORY = "net.emiva.util.SimpleSSLSocketFactory";
    ...
    private EmailService() {
        host = EMIVAGlobals.getProperty("mail.smtp.host", "localhost");
        port = EMIVAGlobals.getIntProperty("mail.smtp.port", 25);
        username = EMIVAGlobals.getProperty("mail.smtp.username");
        password = EMIVAGlobals.getProperty("mail.smtp.password");
        sslEnabled = EMIVAGlobals.getBooleanProperty("mail.smtp.ssl");
        debugEnabled = EMIVAGlobals.getBooleanProperty("mail.debug");
    }
                ...
                (textBody == null && htmlBody == null))
        {
            ...
            try {
                ...
                SimpleDateFormat format = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss Z",
                        java.util.Locale.US);
                format.setTimeZone(EMIVAGlobals.getTimeZone());
    ...
    public void setHost(String host) {
        this.host = host;
        EMIVAGlobals.setProperty("mail.smtp.host", host);
        session = null;
    }
    ...
    public void setPort(int port) {
        ...
        this.port = port;
        EMIVAGlobals.setProperty("mail.smtp.port", Integer.toString(port));
        session = null;
    }
    ...
    public void setUsername(String username) {
        ...
        if (username == null) {
            EMIVAGlobals.deleteProperty("mail.smtp.username");
        }
        else {
            EMIVAGlobals.setProperty("mail.smtp.username", username);
        }
        session = null;
    }
    ...
    public void setPassword(String password) {
        ...
        if (password == null) {
            EMIVAGlobals.deleteProperty("mail.smtp.password");
        }
        else {
            EMIVAGlobals.setProperty("mail.smtp.password", password);
        }
        session = null;
    }
    ...
    public void setDebugEnabled(boolean debugEnabled) {
        ...
        EMIVAGlobals.setProperty("mail.debug", Boolean.toString(debugEnabled));
        session = null;
    }
    ...
    public void setSSLEnabled(boolean sslEnabled) {
        ...
        EMIVAGlobals.setProperty("mail.smtp.ssl", Boolean.toString(sslEnabled));
        session = null;
    }
