...
import net.emiva.util.LinkedListNode;
...
public class DefaultCache<K, V> implements Cache<K, V> {
     ...
     */
    protected net.emiva.util.LinkedList lastAccessedList;

    /**
     * Linked list to maintain time that cache objects were initially added
     * to the cache, most recently added to oldest added.
     */
    protected net.emiva.util.LinkedList ageList;
    ...
    public DefaultCache(String name, long maxSize, long maxLifetime) {
        ...
        lastAccessedList = new net.emiva.util.LinkedList();
        ageList = new net.emiva.util.LinkedList();
    }
