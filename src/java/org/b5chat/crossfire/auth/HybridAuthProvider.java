 ...
 * <tt>org.b5chat.crossfire.auth.HybridAuthProvider</tt>.
 *
 * The primary, secondary, and tertiary providers are configured be setting system properties similar to
 * the following:
 *
 * <ul>
 * <li><tt>hybridAuthProvider.primaryProvider = org.b5chat.crossfire.auth.DefaultAuthProvider</tt></li>
 * <li><tt>hybrodAuthProvider.secondaryProvider = org.b5chat.crossfire.auth.NativeAuthProvider</tt></li>
 * </ul>
 *
