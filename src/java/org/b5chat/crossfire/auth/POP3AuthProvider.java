 ...
 *
 * <ul>
 * <li><tt>provider.auth.className = org.b5chat.crossfire.auth.POP3AuthProvider</tt></li>
 * <li><tt>provider.user.className = org.b5chat.crossfire.user.POP3UserProvider</tt></li>
 * </ul>
 *
