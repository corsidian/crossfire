...
import org.b5chat.crossfire.user.NativeUserProvider;
...
import org.b5chat.crossfire.user.UserProvider;
 ...
 *
 * <ul>
 * <li><tt>provider.auth.className = org.b5chat.crossfire.auth.NativeAuthProvider</tt></li>
 * <li><tt>provider.user.className = org.b5chat.crossfire.user.NativeUserProvider</tt></li>
 * </ul>
 *
...
public class NativeAuthProvider implements AuthProvider {
    ...
    public NativeAuthProvider() {
        ...
        // Configure Shaj to log output to the crossfire logger.
