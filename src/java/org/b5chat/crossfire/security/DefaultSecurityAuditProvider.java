 ...
 */
package org.b5chat.crossfire.security;
...
import org.b5chat.database.SequenceManager;
...
public class DefaultSecurityAuditProvider implements SecurityAuditProvider {
     ...
     * @see org.b5chat.crossfire.security.SecurityAuditProvider#logEvent(String, String, String)
     */
     ...
     * @see org.b5chat.crossfire.security.SecurityAuditProvider#getEvents(String, Integer, Integer, java.util.Date, java.util.Date)
     */
    ...
    /**
     * The default provider retrieves events from a ofSecurityAuditLog table in the database.
     * @see org.b5chat.crossfire.security.SecurityAuditProvider#getEvent(Integer)
     */
     ...
     * @see org.b5chat.crossfire.security.SecurityAuditProvider#getEventCount()
     */
     ...
     * @see org.b5chat.crossfire.security.SecurityAuditProvider#isWriteOnly()
     */
     ...
     * @see org.b5chat.crossfire.security.SecurityAuditProvider#getAuditURL()
     */
     ...
     * @see org.b5chat.crossfire.security.SecurityAuditProvider#blockUserEvents()
     */
     ...
     * @see org.b5chat.crossfire.security.SecurityAuditProvider#blockGroupEvents()
     */
