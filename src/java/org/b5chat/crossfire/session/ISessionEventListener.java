 ...
 * {@link SessionEventDispatcher#addListener(ISessionEventListener)}
...
public interface ISessionEventListener {
     ...
     */
    public void anonymousSessionCreated(ISession session);
     ...
     * @param session the authenticated session of an anonymous user.
     */
    public void anonymousSessionDestroyed(ISession session);
     ...
     */
    public void resourceBound(ISession session);
}