...
public class SessionResultFilter {
     ...
     */
    public Comparator<IClientSession> getSortComparator() {
     ...
     */
    private class SessionComparator implements Comparator<IClientSession> {

        public int compare(IClientSession lhs, IClientSession rhs) {
            int comparison;
            switch (sortField) {
