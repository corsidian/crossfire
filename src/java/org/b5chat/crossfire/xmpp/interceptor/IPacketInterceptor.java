/**
 * $RCSfile: IPacketInterceptor.java,v $
 * $Revision: 3010 $
...
package org.b5chat.crossfire.xmpp.interceptor;
...
public interface IPacketInterceptor {
     ...
     */
    void interceptPacket(Packet packet, ISession session, boolean incoming, boolean processed)
