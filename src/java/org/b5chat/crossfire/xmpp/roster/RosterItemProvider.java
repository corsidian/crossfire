...
import org.b5chat.crossfire.database.SequenceManager;
...
public class RosterItemProvider {
     ...
     * method will be cached by crossfire. In some cases, the roster item passed in will be passed
     ...
     *
     * If you don't want roster items edited through crossfire, throw UnsupportedOperationException.
     *
     * @param username the username of the user/chatbot that owns the roster item
     ...
     *
     * If you don't want roster items deleted through crossfire, throw
