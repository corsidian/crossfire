...
package org.b5chat.crossfire.xmpp.stream;
 ...
 */
public class BasicStreamIDFactory implements IStreamIdFactory {
    ...
    public IStreamId createStreamID(String name) {
        return new BasicStreamID(name);
    }

    private class BasicStreamID implements IStreamId {
        String id;
