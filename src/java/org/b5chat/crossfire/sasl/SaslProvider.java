...
package org.b5chat.crossfire.sasl;
...
public class SaslProvider extends Provider {
    ...
    public SaslProvider() {
        ...
        put("SaslServerFactory.PLAIN", "org.b5chat.crossfire.sasl.SaslServerFactoryImpl");
        // Add SaslServer supporting the Clearspace SASL mechanism
        put("SaslServerFactory.CLEARSPACE", "org.b5chat.crossfire.sasl.SaslServerFactoryImpl");
    }
}