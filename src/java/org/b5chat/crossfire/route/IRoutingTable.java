 ...
 * <ul>
 * <li>ISession - A local or remote session belonging to the server's domain.
 ...
 * should indicate that route with a null resource component of the XMPPAddress. ISession
...
public interface IRoutingTable {
     ...
     */
    IClientSession getClientRoute(JID jid);
     ...
     */
    Collection<IClientSession> getClientsRoutes(boolean onlyLocal);
    ...
    /**
     * Sets the {@link IRemotePacketRouter} to use for deliverying packets to entities hosted
     * in remote nodes of the cluster.
     *
     * @param remotePacketRouter the IRemotePacketRouter to use for deliverying packets to entities hosted
     *        in remote nodes of the cluster.
     */
    void setRemotePacketRouter(IRemotePacketRouter remotePacketRouter);

    /**
     * Returns the {@link IRemotePacketRouter} to use for deliverying packets to entities hosted
     * in remote nodes of the cluster or <tt>null</tt> if none was set.
     *
     * @return the IRemotePacketRouter to use for deliverying packets to entities hosted
     *        in remote nodes of the cluster.
     */
    IRemotePacketRouter getRemotePacketRouter();
