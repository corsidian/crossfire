...
import org.b5chat.crossfire.group.IGroupEventListener;
import org.b5chat.crossfire.group.SharedGroupException;
import org.b5chat.crossfire.route.IRoutingTable;
import org.b5chat.crossfire.server.XmppServer;
import org.b5chat.crossfire.user.IUserEventListener;
...
public class RosterManager extends BasicModule implements IGroupEventListener, IUserEventListener {
     ...
     * @throws org.b5chat.crossfire.user.UserNotFoundException if the ID does not correspond
