...
public class UserEventDispatcher {
    ...
    private static List<IUserEventListener> listeners =
            new CopyOnWriteArrayList<IUserEventListener>();
     ...
     */
    public static void addListener(IUserEventListener listener) {
        if (listener == null) {
     ...
     * @param listener the listener.
     */
    public static void removeListener(IUserEventListener listener) {
