...
package org.b5chat.crossfire.core.starter;
 ...
 *
 * This class should be for standalone mode only. crossfire servers launched
 ...
 * </ul>
 *
 * Note: if the enviroment property <tt>crossfire.lib.directory</tt> is specified
 * ServerStarter will attempt to use this value as the value for crossfire's lib
...
public class ServerStarter {
    ...
    private void start() {
        ...
        try {
            ...
            String libDirString = System.getProperty("crossfire.lib.dir");
            ...
            String adminLibDirString = System.getProperty("crossfireHome");
            ...
            if (adminLibDir.exists()) {
                ...
                logger.warn("Admin Lib Directory " + adminLibDirString +
