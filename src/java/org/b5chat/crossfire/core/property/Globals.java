    ...
    public static void migrateProperty(String name) {
        ...
        if (getXMLProperty(name) != null) {
            if (getProperty(name) == null) {
                ...
                Log.warn("Property '"+name+"' as specified in crossfire.xml differs from what is stored in the database.  Please make property changes in the database instead of crossfire.xml.");
            }
        }
    }
