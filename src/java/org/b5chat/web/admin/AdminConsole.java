...
import org.b5chat.util.PropertyEventDispatcher;
import org.b5chat.util.PropertyEventListener;
...
public class AdminConsole {
    ...
    static {
        ...
        // This is to add the tab after crossfire setup
        PropertyEventListener propListener = new PropertyEventListener() {
            public void propertySet(String property, Map params) {
                if ("provider.auth.className".equals(property)) {
                    String value = (String) params.get("value");
                    if ("org.b5chat.crossfire.clearspace.ClearspaceAuthProvider".equals(value)) {
                        rebuildModel();
                    }
                }
            }
    ...
    public static synchronized String getVersionString() {
        ...
        if (globalVersion != null) {
            ...
            // Default to the crossfire version if none has been provided via XML.
     ...
     *      or <tt>null</tt> if the standard crossfire resource bundle should be used.
    ...
    private static void load() {
        ...
        if (in == null) {
            Log.error("Failed to load admin-sidebar.xml file from crossfire classes - admin "
